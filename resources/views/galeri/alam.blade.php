...
@section('content')
    ...
    <div class="relative bg-cover bg-center h-72 md:h-96 lozad page-banner"
         data-background-image="{{ asset('images/alam_banner_placeholder.jpg') }}" {{-- GANTI DENGAN GAMBAR BANNER ALAM ANDA --}}
         style="background-image: url('{{ asset('images/alam_banner_placeholder.jpg') }}');"> {{-- GANTI DENGAN GAMBAR BANNER ALAM ANDA --}}
