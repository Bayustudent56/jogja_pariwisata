...
<div class="w-full">
    ...
    @if($artikel->gambar)
    <div class="hero-section-full" style="background-image: url('{{ asset('storage/' . $artikel->gambar) }}');">
        ...
        <div class="hero-content-container container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="hero-meta-container text-sm text-gray-200">
                <span class="hero-meta-item">
                    ...
                    {{ $artikel->created_at->isoFormat('D MMMM YYYY') }}
                </span>
                <span class="hero-meta-item">
        ...
        <div class="hero-content-container container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="hero-meta-container text-sm text-gray-300">
                <span class="hero-meta-item">Dibuat:
                    {{-- PERBAIKAN FORMAT TANGGAL YANG AMAN (pada fallback) --}}
                    {{ $artikel->created_at->isoFormat('D MMMM YYYY') }}
                </span>
                <span class="hero-meta-item">
                    @if($artikel->kategoriArtikel)
