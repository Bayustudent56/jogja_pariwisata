...
@section('content')
    ...
    <div class="relative bg-cover bg-center h-72 md:h-96 lozad page-banner" {{-- Ditambahkan kelas 'page-banner' agar script Lozad bekerja --}}
         data-background-image="{{ asset('images/artikel.jpg') }}"
         style="background-image: url('{{ asset('images/artikel.jpg') }}');">
        ...
        <div class="container mx-auto px-4 h-full flex items-center justify-center text-center">
            ...
            Menjelajahi Pesona Jogja: Budaya, Kuliner, dan Alamnya
            </h1>
        </div>
    </div>

    {{-- Breadcrumbs and Artikel --}}
    <div class="container mx-auto px-4 mt-10 mb-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mt-8">
            @php
                $galleryItems = [
                    ['title' => 'Alam', 'image' => asset('images/alam.jpg'), 'link' => '#art-culture'],
                    ['title' => 'Budaya & Sejarah', 'image' => asset('images/budaya2.jpg'), 'link' => '#culinary'],
                    ['title' => 'Edukasi', 'image' => asset('images/edukasi.jpeg'), 'link' => '#landscape'],
                    // PERUBAHAN PADA BARIS DI BAWAH INI
                    ['title' => 'Kreatif', 'image' => asset('images/kreatif.jpeg'), 'link' => '#sports-adventure'],
                    ['title' => 'Kuliner Tradisional', 'image' => asset('images/kulinertradi.png'), 'link' => '#health-wellness'],
                    ['title' => 'Kuliner Kekinian', 'image' => asset('images/kekinian.jpg'), 'link' => '#creative-economy'],
                ];
            @endphp
